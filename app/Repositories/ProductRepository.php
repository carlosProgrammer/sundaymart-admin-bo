    ...
    public function datatable($collection = [])
    {
        ...
        if (!empty($datas)) {
            foreach ($datas as $data) {
                ...
                $nestedData['commission_price'] = $data->price + $data->commission;
                $nestedData['options'] = [
                    'delete' => 1,
                    'edit' => 1
                ];
...
//            ->get();
    ...
    public function active($shop_id)
    {
        ...
        foreach ($products as $product) {
            $data[] = [
                ...
                'commission_price' => $product->price + $product->commission
     ...
     */
    private function responseProductShow($product): \Illuminate\Http\JsonResponse
    {
        ...
        $product = collect($product)->merge([
            'price' => $product->price + $product->commission,
