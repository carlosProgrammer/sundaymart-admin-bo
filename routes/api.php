...
Route::post('/shop/deactivated/{uuid}', [ClientController::class, 'deactivateShop']);
Route::post('/shop/activated/{uuid}', [ClientController::class, 'activateShop']);
...
Route::group([
    ...
    Route::get('/payment-system/verify', [BasePaymentController::class, 'checkTransaction']);
